#we first dycrypts an encrypted flag by calculating  a shared secret using elliptic curve cryptography 
# then decrypts the flag using AES in CBC mode to check padding with PKCS7 and remove padding when converting to plaintext#
