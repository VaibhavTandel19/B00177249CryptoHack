# ECB CBC WTF lab
#we are encrypting the flag AES in CBC mode to get cipher text
# then we XOR the ciphertext block with original block to get decrypted blocks
# then we combine the blocks to get string value#
