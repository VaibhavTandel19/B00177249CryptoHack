# Flipping Cookie lab
#we are manupalating an encrypted cookie to change its value from admin=false to true using XOR
# then we send modified cookie to the server to confirm the authorization  #
