#in this first we connect to server and send specific value of p,g A  to maupalate key exchange
# then it decrypts the flag using AES in CBC mode
# then we exploit the weakness of the server to get flag #
