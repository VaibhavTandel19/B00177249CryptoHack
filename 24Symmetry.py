# Symmetry lab
#we are extracting an encrypted png file from the url
# then we are XOR the result with a PNG header to get the outcome image#
...
with open(r"C:\path\to\flag.png", 'wb') as f:
    f.write(pt)